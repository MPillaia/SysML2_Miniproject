"""
This script is called by the plugin-wrapper, requirements_recreate.js, which passes down the
...
from requirements_recreate import requirements_recreate
...
plugin = requirements_recreate(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
