"""
This script is called by the plugin-wrapper, requirements_write.js, which passes down the
...
from requirements_write import requirements_write
...
plugin = requirements_write(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
