"""
This script is called by the plugin-wrapper, parametric_recreate.js, which passes down the
...
from parametric_recreate import parametric_recreate
...
plugin = parametric_recreate(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
