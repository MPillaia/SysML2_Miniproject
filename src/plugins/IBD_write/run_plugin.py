"""
This script is called by the plugin-wrapper, IBD_write.js, which passes down the
...
from IBD_write import IBD_write
...
plugin = IBD_write(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
