"""
This script is called by the plugin-wrapper, parametric_write.js, which passes down the
...
from parametric_write import parametric_write
...
plugin = parametric_write(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
